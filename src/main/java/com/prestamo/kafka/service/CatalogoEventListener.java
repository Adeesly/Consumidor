...
public class CatalogoEventListener {
    ...
    @KafkaListener(
        topics = "${topic.catalogo.name:topic-catalogo-SIERRA}",
    ...
    public void consumer(Event<?> event) {
        ...
        if (event.getClass().isAssignableFrom(CatalogoCreateEvent.class)) {
            ...
            int idCatalogo = objCatalogo.getIdCatalogo(); // Asegúrate de tener este método en Catalogo
            String descripcion = objCatalogo.getDescripcion(); // Asegúrate de tener este método en Catalogo
            ...
            System.out.println(">>7  Descripción: " + descripcion);
        }
    }
}
